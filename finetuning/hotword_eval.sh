...
# HOTWORD_FILE=""
OUTPUT_DIR="/cfs/data/private/WangYaoChi/test_out/joint_ctc_14/hotword_aishell/ctc1"
...
PROMPT="你是一个拥有超高精度的语音识别引擎。请根据音频内容进行识别，当遇到音素类似的词汇时，必须优先匹配列表中的专属名词，而不是通用词汇。"
STREAM=1
