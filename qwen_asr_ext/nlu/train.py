...
from qwen_asr_ext.joint.lora import apply_lora, assert_only_text_decoder_trainable
from qwen_asr_ext.joint import Qwen3ASRJointModel
from qwen_asr_ext.joint.defaults import DEFAULT_ATTN_IMPLEMENTATION
from qwen_asr_ext.nlu.common import NLU_SYSTEM_PROMPT, build_nlu_prompt, nlu_messages
...
def main():
    ...
    if args.full_ft:
        if args.backend == "joint":
            from qwen_asr_ext.joint.train import set_trainable
    ...
    if args.backend == "joint" and args.full_ft:
        from qwen_asr_ext.joint.train import JointTrainer
