#!/bin/bash
# qwen_asr_ext/nlu/scripts/train_asr.sh — ASR + ASR+NLU 联合 LoRA SFT wrapper
# 用法: bash qwen_asr_ext/nlu/scripts/train_asr.sh [GPU_IDS]
#
