...
from qwen_asr_ext.joint.model import (
    Qwen3ASRJointModel,
    audio_prompt,
    inject_audio,
    left_tokenize,
...
from qwen_asr_ext.joint.encoder import encode_offline, feature_lens
...
# 与 qwen_asr_ext/joint/model.py 的 decode_llm 路径对齐：音频 embedding 由 encode_offline
