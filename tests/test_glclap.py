...
from qwen_asr_ext.glclap.benchmark import load_hotword_benchmark, normalize_text, read_candidates, read_key_value
...
from qwen_asr_ext.glclap.model import feature_mask, glclap_loss
...
def test_benchmark_files_are_normalized_and_deduplicated(tmp_path):
...
def test_load_hotword_benchmark_builds_sorted_records(tmp_path):
